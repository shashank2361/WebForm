...
namespace Webforms {
    ...
    public partial class EmpDataset : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FirstName, string LastName, string Gender, int Salary, System.DateTime DateOfBirth, string Country) {
...
namespace Webforms.EmpDatasetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([FirstName], [LastName], [Gender], [Salary], [Date" +
                "OfBirth], [Country]) VALUES (@FirstName, @LastName, @Gender, @Salary, @DateOfBir" +
                "th, @Country)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [FirstName] = @FirstName, [LastName] = @LastName, [G" +
                "ender] = @Gender, [Salary] = @Salary, [DateOfBirth] = @DateOfBirth, [Country] = " +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, Gender, Salary, DateOfBirth, Country FROM dbo.Emp" +
                "loyees";
        ...
        public virtual int Fill(EmpDataset.EmployeesDataTable dataTable) {
        ...
        public virtual EmpDataset.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EmpDataset.EmployeesDataTable dataTable = new EmpDataset.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmpDataset.EmployeesDataTable dataTable) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Gender, global::System.Nullable<int> Salary, global::System.Nullable<global::System.DateTime> DateOfBirth, string Country) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Gender, global::System.Nullable<int> Salary, global::System.Nullable<global::System.DateTime> DateOfBirth, string Country, int Original_ID) {
            if ((FirstName == null)) {
